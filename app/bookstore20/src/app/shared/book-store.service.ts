  ...
  constructor() {
    this.books = [
      new Book(1,
        '9783864903571',
        'Angular',
        [new Author(1, 'Johannes', 'Hoppe'), new
        Author(2, 'Danny', 'Koppenhagen'),
          new Author(3, 'Ferdinand', 'Malcher'), new Author(4, 'Gregor',
          'Woiwode')],
        new Date(2017, 3, 1),
        1,
      ...
      new Book(2,
        '9783864901546',
        'AngularJS',
        [new Author(5, 'Philipp', 'Tarasiewicz'), new Author(6, 'Robin',
          'Böhm')],
        new Date(2014, 5, 29),
        1,
